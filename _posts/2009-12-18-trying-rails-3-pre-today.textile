...
@# Add the following line right before require 'active_support/ruby/shim'@
...
*UPDATE*: If you want to check out an application that is exactly that far, you can check out my "Rails 3 sample application":http://github.com/ralph/sample-rails-3.0-project from Github.
