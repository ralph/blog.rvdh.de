...
That's the easy part. Just clone the "official Rails git repository":http://github.com/rails/rails:

@git clone git://github.com/rails/rails.git@

Next you will have to update the Rails submodules, as the rails command needs rack and arel:
